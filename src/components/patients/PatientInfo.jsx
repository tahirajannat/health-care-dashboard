...
export default function PatientInfo({ classes }) {
  return (
        ...
        <div className="flex flex-col items-start gap-4 my-4">
          <div className="flex gap-4 items-center">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-gray-600">August 23, 1996</p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-center">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-gray-600">Female</p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-center">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-gray-600">(415) 555-1234</p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-center">
            ...
            <div>
              <p className="text-xs text-gray-600 mb-1">Emergency Contacts</p>
              <p className="text-xs font-bold text-gray-600">(415) 555-1234</p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-center">
            ...
            <div>
              <p className="text-xs text-gray-600 mb-1">Insurance Provider</p>
